#ifndef ISP_PS3210M_H_
#define ISP_PS3210M_H_ 1

#include <bd_sns_ctrl.h>

#if defined(SENSOR_ESTYPE)
/* 20160325 ps3210K based */
static const unsigned short init_p3210m_bayer_config[] = {
    0x0300, 
	0x0503, 
	0x0608, 		// 30 fps
    0x0797, 
...
static struct isp_ctrl_info init_p3210m_values = {
#if defined(SENSOR_ESTYPE)
	.chip_id = 0xbd01,
#else
	.chip_id = 0x2210,
