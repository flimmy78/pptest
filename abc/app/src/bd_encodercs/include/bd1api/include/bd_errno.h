...
#ifndef __BD_ERRNO_H__
#define __BD_ERRNO_H__
...
#define BD_ERR_APPID  (0x80000000L + 0x20000000L)

typedef enum bdERR_LEVEL_E
{
...
#define BD_DEF_ERR( module, level, errid) \
    ((BD_S32)( (BD_ERR_APPID) | ((module) << 16 ) | ((level)<<13) | (errid) ))

/* NOTE! the following defined all common error code,
** all module must reserved 0~63 for their common error code
*/
typedef enum bdEN_ERR_CODE_E
{
